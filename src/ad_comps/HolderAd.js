...
function HolderAd(props) {
    ...
    const postNewAd = (event) => {
        ...
        if (cat && to && from && com) {
            ...
            let url = "http://localhost:3000/ads/add";
        ...
        <div className="App" style={{ textAlign: "center" }}>
            ...
            <form onChange={onChangePostForm}>
                ...
                <div style={{ marginBottom: "10px" }}>
                    ...
                    {/* <span id="msgAdFrom" style={{ fontSize: "11px", display: "none", color: "blue" }}>&#10008;</span> */}
            ...
            {/* <div>
                {adDataState === null ? <p>{adDataState}</p> :
                    <div>
                        <p>{adDataState.category}</p>
                        <p>{adDataState.comment}</p>
                    </div>
                }
            </div> */}
        </div>
