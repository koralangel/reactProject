              ...
              <div className="col-md-7 user-details">
                  <div className="row coralbg">
                      ...
                      <div className="col-md-8 no-pad">
                          <div className="user-image modal-xl" data-toggle="modal" data-target="#myModal" style={{height: "100%", display:"flex", flexDirection:"row", alignItems:"center" }} id="gallery" className="modal-body">                          
