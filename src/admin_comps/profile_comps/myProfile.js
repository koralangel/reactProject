                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div id="gallery" className="modal-body">
                                <img className="img-responsive thumbnail" id="id-img" src={apiUrl + "images/users_imgs/" + profileSingle.image} width="200" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="row coralbg">
                            ...
                            <div className="col-md-8 no-pad">
                                ...
                                <div className="user-image" data-toggle="modal" data-target="#myModal">  
                                    <img className="img-responsive thumbnail" src={apiUrl + "images/users_imgs/" + profileSingle.image} id="id-file" />
