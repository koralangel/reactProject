...
function Nav() {
    ...
    useEffect(() => {
        ...
        socket.on("back alert", msgBackEnd => {
            let tokenUser = parseJwt(localStorage["tok"])
                ...
                .then(data => {
                    if (data.first_name) {
                        if (data.vip.vip === true){
                            localStorage.setItem("vips", "0")

                        }
                        else{
                            localStorage.setItem("vips", "1")
            ...
            <div className="container-fluid">
                ...
                <div style={{ display: "flex", alignItems: "center" }}>
                    {userData.image === undefined ? null :
                        <img style={{ borderRadius: "100px", width: "50px", marginRight: "6px", height: "48px" }} src={'http://localhost:3000/images/users_imgs/' + userData.image[0]} width="169px" />
                    }
