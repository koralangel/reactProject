...
//       document.getElementById("didi").classList.add("nav-sticky");
//     }
//     else {
//       document.getElementById("didi").classList.remove("nav-sticky");
//     }
//   }
    ...
    const sendLoginForm = (event) => {
        ...
        let urlAdmins = "http://localhost:3000/admins/login";
