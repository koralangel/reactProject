...
import { doApiPostToken, doApiGet } from '../services/apiService';
...
function ChatBox(props) {
    ...
    useEffect(() => {
        ...
        let url = "http://localhost:3000/msgs/single/" + props.match.params.id;
        doApiGet(url)
            .then(data => {
                if (data._id) {
    ...
    const sendMsg = () => {
        ...
        let urlMsg = "http://localhost:3000/msgs/update";
            ...
            <div style={{ background: "lightsteelblue" }} className="card-header msg_head">
                <div className="d-flex bd-highlight">
                    <div style={{ cursor: adminS === true ? "unset" : "pointer" }} onClick={goToPro} className="img_cont">
                        <img src={'http://localhost:3000/images/users_imgs/' + userChatData.img} className="rounded-circle user_img" />
