...
import { doApiGetToken, doApiPostToken } from '../services/apiService';
...
function UserSingle(props) {
            ...
            .then(data1 => {
                if (data1) {
                    ...
                    if (userData.length < 1) {
                        ...
                        let urlOwner = "http://localhost:3000/users/single";
    ...
    const onClickReport = (e) => {
        ...
        let urlRe = "http://localhost:3000/reports/add";
    ...
    const onBlockUser = () => {
        ...
        let url2 = "http://localhost:3000/users/updateanother";
            ...
            <div className="container" >
                <div className="modal fade" id="myModal" role="dialog">
                    <div className="modal-dialog modal-xl">
                        ...
                        {/* http://localhost:3000/images/users_imgs/pic1.jpeg */}
                            ...
                            <div style={{ height: "635px", display: "flex", flexDirection: "row", alignItems: "center" }} id="gallery" className="modal-body">
                                ...
                                <div style={{ display: "flex", flexDirection: "row", margin: "auto" }} id="gal-round1" >
                                    ...
                                    <div style={{ display: "flex" }} id="gal-round2" >
                                        <img id="img-gallery1" className="img-responsive thumbnail" src={'http://localhost:3000/images/users_imgs/' + imgArr[imgIndex]} />
                                    </div>
                    ...
                    <div className="row user-menu-container square" >
                        <div className="col-md-7 user-details">
                         ...
                         className="img-responsive thumbnail"></img> */}
                                        <img className="img-responsive thumbnail" src={'http://localhost:3000/images/users_imgs/' + imgArr[0]} />
