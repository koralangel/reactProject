...
function Home() {
    ...
    useEffect(() => {
        ...
        let urlEx = "http://localhost:3000/ads/delexpired";
        ...
        let urlAd = 'http://localhost:3000/ads/single';
        doApiGetToken(urlAd)
            .then(data => {
                if (data === null) {
                    ...
                    let urlUserUp = "http://localhost:3000/users/update";
    ...
    const delPost = () => {
        let url = "http://localhost:3000/ads/deluserad";
        doApiPostToken(url)
            .then(data => {
                if (data.message) {
                    alert("Post deleted")
        ...
        let urlUser = "http://localhost:3000/users/update";
